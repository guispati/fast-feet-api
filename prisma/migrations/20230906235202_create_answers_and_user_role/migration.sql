...
-- AddForeignKey
ALTER TABLE "answers" ADD CONSTRAINT "answers_question_iid_fkey" FOREIGN KEY ("question_iid") REFERENCES "questions"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
